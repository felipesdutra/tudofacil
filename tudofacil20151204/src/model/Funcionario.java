...
public class Funcionario  implements Serializable{
	...
	public Funcionario() {		
		...
		c2.setTime(this.getEntrada());		
		
		int minutosAgora = (c1.get(Calendar.MINUTE) +(c1.get(Calendar.HOUR)*60));
		int minutosEntrada = (c2.get(Calendar.MINUTE) +(c2.get(Calendar.HOUR)*60));
		*/
