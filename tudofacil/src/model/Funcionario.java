...
public class Funcionario implements Serializable {
	...
	@Transient
	boolean estaEmIntervalo;
	
	@Transient
	boolean estaEmIntervalo10Min;
	...
	public boolean isEstaEmIntervalo() {
		return estaEmIntervalo;
	}

	public void setEstaEmIntervalo(boolean estaEmIntervalo) {
		this.estaEmIntervalo = estaEmIntervalo;
	}
	...
	public boolean isEstaEmIntervalo10Min() {
		return estaEmIntervalo10Min;
	}

	public void setEstaEmIntervalo10Min(boolean estaEmIntervalo10Min) {
		this.estaEmIntervalo10Min = estaEmIntervalo10Min;
	}
	...
	public int hashCode() {
		...
		result = prime * result + (estaEmIntervalo ? 1231 : 1237);
		result = prime * result + (estaEmIntervalo10Min ? 1231 : 1237);
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (entrada == null) {
			...
			return false;
		if (estaEmIntervalo != other.estaEmIntervalo)
			return false;
		if (estaEmIntervalo10Min != other.estaEmIntervalo10Min)
			return false;
		if (horaSaida == null) {
	...
	public String toString() {
		return "Funcionario [id=" + id + ", nome=" + nome + ", entrada="
				+ entrada + ", horaSaida=" + horaSaida + ", almoco=" + almoco
				+ ", horacomputador=" + horacomputador + ", tempoTotal="
				+ tempoTotal + ", estaEmIntervalo=" + estaEmIntervalo
				+ ", estaEmIntervalo10Min=" + estaEmIntervalo10Min
